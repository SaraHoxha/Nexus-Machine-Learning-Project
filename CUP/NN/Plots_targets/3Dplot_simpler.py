...
path_to_save = "CUP/NN/Plots_targets/simpler"
num_models = 20

for i in range(num_models):
    pred_targets_training = pd.read_csv(f"CUP/NN/NNselection/simpler/Predicted_vals_best_models/training/training_pred_labels_simpler_model_{i}.csv")
    pred_targets_test = pd.read_csv(f"CUP/NN/NNselection/simpler/Predicted_vals_best_models/test/test_pred_labels_simpler_model_{i}.csv")
