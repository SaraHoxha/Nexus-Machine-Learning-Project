...
model_names = ["MLP0","MLP1","MLP2","MLP3","MLP4","MLP5","MLP6","MLP7","MLP8","MLP9"]
...
# Customize the plot
plt.title("Learning Curves of 10 best complex NN Models(Loss)")
plt.xlabel("Epochs")
plt.ylabel("Loss(MSE)")
...
# Customize the plot
plt.title("Learning Curves of 10 best complex NN Models(Accuracy)")
plt.xlabel("Epochs")
plt.ylabel("Accuracy")
plt.legend(loc='upper right')
plt.grid(True)
