...
for i in range(num_models):
    pred_test = pd.read_csv(f'CUP/NN/NNselection/simpler/Predicted_vals_best_models/test_pred_labels_simpler_model_{i}.csv',names=['X', 'Y', 'Z'])
...
with open('CUP/NN/MEE/simpler/test_models.csv', 'w', newline='') as f:
