...
#NOTES:
    #In this plot we can see as shown in the simple correlation heat map that attribute D is almost none important for the targets.
...
X = df_training.drop(columns=["id","X","Y","Z"])  # Exclude the target column
y = df_training[["X","Y","Z"]]  # Your target column
