...
print(f"For KNN in regards to Monk 1 Training, best parameters are {knn_search.best_params_} with a score of {knn_search.best_score_:0.5f}") #0.821
...
print(f"For KNN in regards to Monk 1 Testing, accuracy score is {test_accuracy:0.5f}") #0.83295
