...
# Customize the plot
plt.title("Learning Curves of 5 best monk1 NN Models(Loss)")
plt.xlabel("Epochs")
...
#plt.show()
plt.savefig('monk+s+problems/Problem1/slidesplots/loss_monk1_models5.png')
plt.clf
...
# Customize the plot
plt.title("Learning Curves of 5 best monk1 NN Models(Accuracy)")
plt.xlabel("Epochs")
plt.ylabel("Accuracy")
plt.legend(loc='upper right')
plt.grid(True)
#plt.show()
plt.savefig('monk+s+problems/Problem1/slidesplots/acc_monk1_models5.png')
plt.clf