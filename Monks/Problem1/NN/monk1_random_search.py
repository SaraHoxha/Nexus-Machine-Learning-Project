...
dir_name = "Monks/Problem1/NN/Trials"
...
for i in range(5):
    ...
    with open(f'Monks/Problem1/NN/Hyperparams/json/model_{i}.json', 'w') as f:
...
for i in range(5):
    ...
    # Write the JSON object to a file
    with open(f'Monks/Problem1/NN/Models/json/model_{i}.json', 'w') as f:
...
for i in range(5):
    ...
    model.save(f'Monks/Problem1/NN/Models/keras/model_{i}.keras')
