...
print(f"For Random Forest in regards to Monk 2 Training, best parameters are {rf_search.best_params_} with a score of {rf_search.best_score_:0.5f}") #0.74403
...
print(f"For Random Forest in regards to Monk 2 Testing, accuracy score is {test_accuracy:0.5f}")  #0.79814
