...
print(f"For KNN in regards to Monk 2 Training, best parameters are {knn_search.best_params_} with a score of {knn_search.best_score_:0.5f}")
...
print(f"For KNN in regards to Monk 2 Testing, accuracy score is {test_accuracy:0.5f}")
mse = mean_squared_error(Y_test, predictions_test)
print(f"For KNN in regards to Monk 2 Testing, MSE is {mse:0.5f}")
