...
print(f"For Logistic Regression in regards to Monk 2 Training, best parameters are {logreg_search.best_params_} with a score of {logreg_search.best_score_:0.5f}")
...
print(f"For Logistic Regression in regards to Monk 2 Testing, accuracy score is {test_accuracy_logreg:0.5f}")
mse = mean_squared_error(Y_test, predictions_test_logreg)
print(f"For Logistic Regression in regards to Monk 2 Testing, MSE is {mse:0.5f}")
...
plt.title('Confusion Matrix Test Monk 2 Logistic Regression')
