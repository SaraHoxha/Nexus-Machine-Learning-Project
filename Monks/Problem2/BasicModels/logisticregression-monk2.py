...
print(f"For Logistic Regression in regards to Monk 2 Training, best parameters are {logreg_search.best_params_} with a score of {logreg_search.best_score_:0.5f}") #0.66767
...
print(f"For Logistic Regression in regards to Monk 2 Testing, accuracy score is {test_accuracy_logreg:0.5f}") #0.66589
