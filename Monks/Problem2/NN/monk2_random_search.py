...
dir_name = "monk+s+problems/Problem2/Trials"
...
for i in range(5):
    ...
    with open(f'monk+s+problems/Problem2/Hyperparams/json/model_{i}.json', 'w') as f:
...
for i in range(5):
    ...
    # Write the JSON object to a file
    with open(f'monk+s+problems/Problem2/Models/json/model_{i}.json', 'w') as f:
...
for i in range(5):
    ...
    model.save(f'monk+s+problems/Problem2/Models/keras/model_{i}.keras')
