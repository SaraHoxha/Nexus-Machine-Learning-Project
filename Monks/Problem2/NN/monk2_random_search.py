...
dir_name = "Monks/Problem2/NN/Trials"
...
for i in range(5):
    ...
    with open(f'Monks/Problem2/NN/Hyperparams/json/model_{i}.json', 'w') as f:
...
for i in range(5):
    ...
    # Write the JSON object to a file
    with open(f'Monks/Problem2/NN/Models/json/model_{i}.json', 'w') as f:
...
for i in range(5):
    ...
    model.save(f'Monks/Problem2/NN/Models/keras/model_{i}.keras')
