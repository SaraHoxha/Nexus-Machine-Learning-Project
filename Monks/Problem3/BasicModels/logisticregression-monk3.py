...
print(f"For Logistic Regression in regards to Monk 3 Training, best parameters are {logreg_search.best_params_} with a score of {logreg_search.best_score_:0.5f}") #0.78567
...
print(f"For Logistic Regression in regards to Monk 4 Testing, accuracy score is {test_accuracy_logreg:0.5f}") #0.82135
